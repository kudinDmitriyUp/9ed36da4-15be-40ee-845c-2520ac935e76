...
export const metadata: Metadata = {
  title: "Modus Pizzeria Milano | Autentica Pizza Cilentana",
  description: "Modus è l'evoluzione di un sogno: portare l'autenticità dei sapori cilentani nel cuore di Milano. Pizza artigianale, ingredienti selezionati, passione per il Cilento.",
  keywords: "pizza milano, pizza cilentana, pizza autentica, ristorante milano, pizzeria milano, paolo de simone",
  metadataBase: new URL("https://moduspizzeriamilan.it"),
  alternates: {
    canonical: "https://moduspizzeriamilan.it"
  },
  openGraph: {
    title: "Modus Pizzeria Milano",
    description: "L'autenticità dei sapori cilentani nel cuore di Milano",
    url: "https://moduspizzeriamilan.it",
    siteName: "Modus Pizzeria",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764078259039-2azv36te.jpg",
      alt: "Modus Pizzeria - Authentic Cilento Pizza in Milan"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Modus Pizzeria Milano",
    description: "Autentica pizza cilentana nel cuore di Milano",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1764078259039-2azv36te.jpg"]
  },
  robots: {
    index: true,
    follow: true
